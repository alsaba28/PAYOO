const electricityBill = document
  .getElementById("latest-electricity-bill")
...
const bankDeposit = document
  .getElementById("latest-bank-deposit")
  .addEventListener("click", function () {
    alert(
...
const mobileRecharge = document
  .getElementById("latest-mobile-recharge")
  .addEventListener("click", function () {
    alert(
...
const gasBill = document
  .getElementById("latest-gas-bill")
  .addEventListener("click", function () {
   alert(
